...
public abstract class ReactiveAbstractMongoDao {
	...
	private static final Logger LOG = LoggerFactory.getLogger(ReactiveAbstractMongoDao.class);
	
	private final String collectionName;
	private final ReactiveMongoTemplate reactiveMongoTemplate;
	

	protected ReactiveAbstractMongoDao(String collectionName, ReactiveMongoTemplate mongoOperations) {
