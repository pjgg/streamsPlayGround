...
public class TestCollectors extends TestCase {
	...
	public void testCollector(){
		PeopleSummarize result = filterSortMapService.peopleToPeopleSummarize(people.stream());
		org.junit.Assert.assertEquals(result.getFemaleSum(), 4);
		org.junit.Assert.assertEquals(result.getMaleSum(), 6);
		org.junit.Assert.assertEquals(result.getAgeSum(), 346);
	}
